...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {tooltip && (
        <div className="bg-white rounded-xl shadow-lg border border-border px-4 py-3 text-sm text-text-primary max-w-[220px] animate-[fadeIn_0.2s_ease]">
          <p className="font-semibold mb-1">Per WhatsApp schreiben</p>
          <p className="text-text-muted text-xs">
            Schicken Sie uns Fotos & Infos zu Ihrem Fahrzeug!
          </p>
        </div>
      )}
      <a
